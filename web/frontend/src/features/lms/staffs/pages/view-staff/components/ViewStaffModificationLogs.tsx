...
import type { StaffLogEntry } from "@/features/lms/staffs/pages/view-staff/types/staffs-view-types";
import { Text } from "@/components/ui/Text";
import { formatTimestamp as formatDate } from "@/lib/format/date";

interface ViewStaffModificationLogsProps {
  logs: StaffLogEntry[];
  loading: boolean;
...
export default function ViewStaffModificationLogs({
  logs,
  loading,
  onRefresh,
  currentPage,
  ...
  onNextPage,
  onPrevPage,
}: ViewStaffModificationLogsProps) {
  return (
