import { z } from "zod";
import { EditCollectionFormData, EditCollectionConstants } from "@/features/lms/collections/pages/edit-collection/types/collections-edit-types";
...
export function validateFormData(data: EditCollectionFormData, constants: EditCollectionConstants): string | null {
    const base = editCollectionSchema.safeParse(data);
    if (!base.success) {
...
export function getFieldErrors(data: EditCollectionFormData, constants?: EditCollectionConstants): Record<string, string> {
    const issues: Record<string, string> = {};
    const parsed = editCollectionSchema.safeParse(data);
    if (!parsed.success) {
